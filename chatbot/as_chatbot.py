...
AS_KNOWLEDGE = [
    ...
    },
    {
        ...
        "content": (
            "수선 비용 안내 기준:\n"
            "- 실물 진단 전(접수중·접수완료·픽업완료·손상부위 진단중): "
            "확정 금액이 없으므로 'AI 예상 견적 받기'에서 사진을 올려 예상 범위를 확인하도록 안내한다.\n"
            "- 실물 진단 완료 후(손상부위 진단완료·수선중·검수중·발송중·완료): "
            "수선 범위와 비용이 이미 확정된 상태다. "
            "'AI 예상 견적 받기'로 돌리지 말고, "
            "AS 조회 화면에서 확인하거나 상담원에게 문의하도록 안내한다.\n"
            "- 자료에 금액이 명시돼 있으면 그 범위를 그대로 말하고 확정가가 아님을 덧붙인다."
        ),
    },
    {
        "topic": "AS 서비스 품질",
    ...
    },
    {
        ...
        "keywords": ["수거", "픽업", "배송", "기사", "보험", "파손", "분실", "택배",
                     "어디에 두", "어디다", "어디에다", "두면", "놔두", "장소", "문 앞"],
        "content": (
            "픽업 수거 안내:\n"
            "신원 확인된 기사가 고객이 지정한 주소로 직접 방문해 제품을 수거합니다.\n"
            "예약한 날짜·시간에 기사가 방문하면 직접 제품을 인계하시면 됩니다. "
            "제품 본체만 준비하시면 되며, 별도 포장이나 동봉물은 필요 없습니다.\n"
            "운송 구간 전체에 보험이 적용됩니다."
        ),
    },
    {
    ...
    },
    {
        ...
        "content": (
            ...
            "- 등록된 주소로 택배 발송되며, 운송장 번호가 등록되면 A/S 조회 화면에서 확인하실 수 있습니다."
        ),
    },
    {
        "topic": "고객센터 안내",
    ...
    {
        "topic": "수선 과정 및 기술",
        "keywords": ["가공", "가공 과정", "수선 과정", "수선 방법", "수선 절차", "어떻게 고쳐",
                     "공정", "복원", "복원 과정", "장인", "기술", "정품부자재", "부자재",
                     "어떤 방식", "어떻게 수선", "수선은 어떻게", "수선 기술", "어떤 기술",
                     "명품 수선", "명품 가공", "가방 가공"],
        "content": (
            "MCM 제품 수선 과정 안내:\n"
            "1) 픽업: 고객 주소에서 제품을 수거해 MCM 수선 센터로 이동합니다.\n"
            "2) 입고 및 진단: 수선 센터에 제품이 입고되면 전문가가 실물을 확인하고 "
            "손상 부위와 수선 범위를 진단합니다.\n"
            "3) 비용 확정: 실물 진단 결과를 바탕으로 수선 비용이 확정됩니다.\n"
            "4) 수선 작업: MCM 공인 기술자가 정품 부자재를 사용해 수선합니다. "
            "가죽 복원, 지퍼 교체, 금속 부품 교체, 스티칭 보수 등 손상 유형에 맞는 방법을 적용합니다.\n"
            "5) 검수: 수선 완료 후 품질 기준에 맞는지 최종 점검합니다.\n"
            "6) 발송: 검수를 통과하면 고객 주소로 배송합니다.\n"
            "정품 부자재와 공인 수선 기술을 사용하므로 원래 제품 품질에 최대한 가깝게 복원됩니다."
        ),
    },
    {
        "topic": "수선 후 AS 보증",
        "keywords": ["수선 후 보증", "보증 기간", "보증기간", "수선 보증", "하자 보증",
                     "AS 보증", "수리 후 보증", "또 고장", "재수선", "다시 고장",
                     "보증이 있나요", "보증이 되나요", "보증 있", "보증 기"],
        "content": (
            "수선 후 하자 보증·보증 기간에 대한 안내:\n"
            "수선 완료 후 보증 기간 및 하자 수선 정책에 대한 구체적인 내용은 "
            "상담원이 직접 확인해 드리는 것이 정확합니다. "
            "MCM 고객센터 상담원에게 문의해 주시면 해당 수선 건의 보증 내용을 안내받으실 수 있습니다."
        ),
    },
    {
        "topic": "구성품 및 보증서 위치",
...
STAGE_GUIDE = {
    ...
    "접수완료": (
        ...
        "기사가 방문하면 접수 시 지정한 주소에서 직접 제품을 인계하면 된다. "
        "제품 본체만 준비하면 되며, 별도 포장은 필요 없다. "
        "구체적인 픽업 날짜·시간은 이 자료에 없다. "
        "고객이 픽업 날짜·시간을 물으면 '접수 시 예약하신 날짜와 시간을 앱에서 확인하시거나, "
        "정확한 일정은 상담원에게 문의해 주시면 안내받으실 수 있습니다'라고 안내한다. "
        "절대 '예약하신 내용을 확인해 주시면 됩니다'처럼 반복하거나 순환 답변을 하지 않는다.",
        "다음: 기사 방문 수거(픽업완료)",
    ),
    "픽업완료": (
        "기사가 제품을 수거해 수선 센터로 이동 중이다. 아직 센터에 도착하지 않았다.",
        "따로 할 일은 없다. "
        "고객이 '언제 받아요?', '수선 끝나면 바로 와요?', '이 날짜가 받는 날인가요?' 등을 물으면 "
        "'전체 AS 완료 예정일 [날짜]까지 수선과 배송이 모두 완료될 예정입니다'라고 답한다. "
        "고객이 '언제 수선해요?', '수선이 언제 시작돼요?', '수선은 언제 하나요?' 등을 물으면 "
        "반드시 이 순서로 답한다: "
        "① '정확한 수선 시작 시점은 별도로 안내드리기 어렵습니다.' "
        "② '전체 AS 완료 예정일은 [날짜]입니다.' "
        "절대 금지: '수선이 완료되면 발송됩니다', '검수·발송에 추가 시간이 필요합니다', "
        "'다음 단계는 손상부위 진단' 등 단계 흐름을 설명하는 표현을 수선 시작 시점 답변에 섞지 않는다. "
        "예상 완료일 이후 추가 단계가 있다는 암시도 금지한다.",
        "다음: 센터 입고 후 실물 진단(손상부위 진단중)",
    ),
    "손상부위 진단중": (
        "제품이 수선 센터에 입고되어 전문가가 실물을 확인하는 중이다. 수선 범위는 아직 확정되지 않았다.",
        "진단 결과가 나오면 안내된다. 지금은 기다리면 된다. "
        "고객이 '진단이 언제 끝나요?', '언제 결과 나와요?' 등 진단 단계의 완료 시점만 물으면 "
        "반드시 이 순서로 답한다: "
        "① '진단 단계의 정확한 완료 시점은 별도로 안내드리기 어렵습니다.' "
        "② '전체 AS 완료 예정일은 [날짜]입니다.' "
        "이 두 문장의 순서를 절대 바꾸지 않는다. "
        "진단 단계의 별도 완료일이 있는 것처럼 날짜를 만들어 말하지 않는다.",
        "다음: 진단 결과 확정(손상부위 진단완료)",
    ),
    "손상부위 진단완료": (
        "실물 진단이 끝나 수선 범위와 비용이 확정된 상태다. 수선 작업은 아직 시작 전이다.",
        "수선 범위와 비용이 확정됐다. "
        "금액을 물으면 'AI 예상 견적 받기'로 돌리지 말고 "
        "'AS 조회 화면에서 확인하시거나, 정확한 금액은 상담원에게 문의해 주세요'라고 안내한다.",
        "다음: 수선 작업 시작(수선중)",
    ),
    "수선중": (
        "수선 센터에서 실제 수선 작업이 진행 중이다. 가장 시간이 걸리는 단계다.",
        "따로 할 일은 없다. "
        "고객이 '수선이 언제 끝나요?', '수선 완료가 언제예요?' 등 수선 단계의 완료 시점만 물으면 "
        "반드시 이 순서로 답한다: "
        "① '수선 단계의 정확한 완료 시점은 별도로 안내드리기 어렵습니다.' "
        "② '전체 AS 완료 예정일은 [날짜]입니다.' "
        "이 두 문장의 순서를 절대 바꾸지 않는다. "
        "고객이 '수선 후 배송까지 얼마나 더 걸려요?' 같이 물으면 "
        "'전체 AS 완료 예정일 [날짜]까지 모두 완료될 예정입니다'라고 안내한다. "
        "검수·발송에 몇 일 걸린다는 식의 자료에 없는 숫자를 말하지 않는다.",
        "다음: 품질 검수(검수중)",
    ),
    "검수중": (
        "수선이 끝나고 품질 기준에 맞는지 최종 점검 중이다. 아직 발송 전이다.",
        "따로 할 일은 없다. "
        "고객이 '검수가 언제 끝나요?', '언제 발송돼요?' 등 검수 단계의 완료 시점만 물으면 "
        "반드시 이 순서로 답한다: "
        "① '검수 단계의 정확한 완료 시점은 별도로 안내드리기 어렵습니다.' "
        "② '전체 AS 완료 예정일은 [날짜]입니다.' "
        "이 두 문장의 순서를 절대 바꾸지 않는다. "
        "검수 완료 시점을 임의로 만들어 말하지 않는다.",
        "다음: 고객 배송 발송(발송중)",
    ),
    "발송중": (
        "검수까지 모두 통과해 수선이 완전히 끝났고, 고객에게 배송이 시작된 상태다. "
        "제품은 이미 센터를 떠났다. 수선·검수는 완료된 것이다.",
        "운송장 번호가 등록되면 A/S 조회 화면에서 확인할 수 있다. "
        "운송장 번호로 택배사 앱이나 홈페이지에서 배송 조회가 가능하다. "
        "수령 시 제품 상태를 확인하면 된다.",
        "다음: 수령 확인(완료)",
    ),
    "완료": (
        "이 접수 건은 모든 단계가 끝났다. 수선·검수·발송·배송을 포함해 진행 중인 절차가 하나도 없다. "
        "'배송 중', '발송 중', '발송된 상태' 같은 표현을 절대 쓰지 마라.",
    ...
    if label in ("완료", "접수 취소"):
        ...
        if idx >= 0:
            if idx > 0:
                ...
                lines.append(
                    "- 이미 끝난 단계: " + " → ".join(completed)
                    + " (이 단계들은 전부 완료됐다. "
                    "고객이 이전 단계의 완료 여부를 물으면 끝났다고 답해라. 부정하지 마라.)"
                )
...
def repair_knowledge(repair):
    ...
    if is_completed:
        ...
        if _stage_label == "발송중":
            ...
            lines.append(f"전체 AS 완료 예정일: {repair['expected_at']}"
                         + (f" (최종 갱신 {upd})" if upd else ""))
...
8. 아래처럼 내용 없는 맺음말은 붙이지 마세요. 안내가 끝나면 그냥 끝내세요.
   ...
   "이 날짜를 참고해 주시면 됩니다" / "이 점 참고해 주시면 됩니다"
...
11. '내 AS 접수' 자료가 있으면 그건 지금 상담 중인 고객의 건입니다.
    ...
    상태·전체 AS 완료 예정일·진행 이력을 그 자료에서 그대로 확인해 답하세요.
...
16. AS와 무관한 잡담(날씨, 음식, 일상 등)이 오면 그 주제는 안내드리기 어렵다고 한 문장으로 말하고 바로 AS 주제로 돌아오세요.
    단, 수선·손상·비용·기간·준비물·접수 방법 등 MCM AS와 관련된 질문은 잡담이 아닙니다. 접수 전 단계라도 AS에 대한 모든 궁금증에 답하세요.
    "수선 접수 말고 물어보고 싶어서", "접수 전에 궁금한 게 있어서" 같은 말은 거절하지 말고 "물론이죠, 궁금하신 점을 편하게 물어보세요"라고 하세요.
    예: "그 부분은 제가 안내드리기 어렵고, MCM 제품 AS 관련 문의만 도와드릴 수 있어요." (음식, 날씨 등 완전 무관한 잡담에만 사용)
17. 고객의 AS 접수 자료(현재 단계·전체 AS 완료 예정일·진행 이력)가 있으면 직접 답하세요.
    "리페어 패스포트에서 확인하세요", "화면에서 보실 수 있습니다" 같은 표현을
    단독 답변으로 쓰지 마세요. 이미 자료를 받아왔는데 화면으로 돌려보내는 것은 안 됩니다.
    화면 안내가 필요하면 답을 먼저 말한 뒤 덧붙이세요.
    (예: "현재 [현재단계] 단계입니다. 전체 AS 완료 예정일은 [날짜]이에요. 자세한 이력은 AS 조회에서도 보실 수 있어요.")
18. 현재 단계가 '발송중'이면 수선·검수는 이미 완전히 끝난 것입니다.
...
21. 같은 내용을 두 번 반복하지 마세요.
    '이렇게 준비해 주시면 됩니다', '이렇게 하시면 됩니다' 같은 표현으로
    방금 말한 내용을 재요약하지 마세요. 할 말을 한 번에 말하고 끝내세요.
22. 이미 AS가 진행 중인 건(수선중·검수중·발송중·완료)에서 고객이 제품 상태 이상을 말하면
    'AI 예상 견적 받기'를 언급하지 마세요. "상담원에게 문의해 주세요"로만 안내하세요.
    AI 견적은 새 접수 전 예상 비용 확인 용도이지, 완료된 수선 결과 이의제기에 쓰는 것이 아닙니다.
23. 수선 취소·제품 반환·AS 거부 등 정책 관련 질문은 자료에 없으면 확정적으로 답하지 마세요.
    절대 쓰지 말 것: "불가능합니다", "수선 절차를 거쳐야 합니다", "할 수 없습니다", "안 됩니다"
    올바른 답변: "그 부분은 상담원에게 문의하시면 정확히 안내받으실 수 있습니다."
    예: "수선 없이 제품을 돌려받을 수 있나요?"
    → "그 부분은 정책에 따라 다를 수 있어, 상담원에게 직접 문의하시면 정확히 안내받으실 수 있습니다." (O)
    → "수선 없이 제품을 돌려받는 것은 불가능합니다." (X — 절대 금지)
24. 현재 단계가 '완료'이면 '발송 중', '배송 중', '발송된 상태', '이미 발송' 같은 표현을 쓰지 마세요.
    모든 절차가 끝난 건이므로 고객이 이미 제품을 수령하셨을 것이라고 안내하세요.
    "배송 중이에요?" 같은 질문에 "아니요, 이미 완료됐습니다"라고 명확히 답하세요.
25. 고객이 '상담원이 이렇게 말했다', '아까 확인해줬다' 같이 다른 채널에서 들은 정보를 언급할 때
    절대 금지 표현: "잘못된 정보", "틀린 안내", "이전에 안내드린 날짜가 잘못됐을 수 있다"
    챗봇은 다른 상담원이 한 말을 알 수 없으므로, 맞다·틀리다 판단 자체를 하지 마세요.
    올바른 패턴: 현재 단계와 전체 AS 완료 예정일만 그대로 말한 뒤 바로 끝내세요.
    예: "현재 전체 AS 완료 예정일은 [날짜]입니다. 더 자세한 내용은 상담원에게 문의하시면 됩니다."
    절대 하지 말 것: "이전에 안내드린 날짜가 잘못됐을 수 있으니" 같은 문장 추가
26. 고객이 '내 이메일', '내 전화번호', '내 주소' 등 자신의 개인정보를 물으면
    "해당 정보는 안내드리기 어렵습니다"라고만 하세요.
    MCM 고객센터 연락처(이메일·전화번호)를 고객의 개인정보로 착각해 답하지 마세요.
27. 자료의 날짜는 '전체 AS 완료 예정일'입니다(수선·검수·배송 모두 포함). 답변에서도 반드시 '전체 AS 완료 예정일'로 부르세요.
    고객이 '수선 완료 후 배송까지 얼마나 더 걸려요?' 같이 물으면:
    올바른 답: "전체 AS 완료 예정일 [날짜]까지 수선과 배송이 모두 완료될 예정입니다."
    절대 금지:
    - "수선이 완료되면 발송됩니다" (전체 AS 완료 예정일 이후에 발송이 이어진다는 암시)
    - "검수·발송에 X일 더 소요됩니다" (자료에 없는 기간을 추측해 말하는 것)
    - "그 후 검수와 발송이 이어질 예정입니다" (전체 AS 완료 예정일 안에 이미 포함된 단계를 이후에 있는 것처럼 표현)
    - 전체 AS 완료 예정일 이후 추가 작업이 있다는 표현 일체
28. [날짜], [금액], [단계], [현재단계] 같은 대괄호 자리표시자를 답변에 절대 쓰지 마세요.
    실제 값이 자료에 없으면 그 문장 자체를 쓰지 말고, "확인이 필요합니다"라고 말하세요.
30. 고객이 자신의 제품 손상을 말하면(예: "지퍼가 뜯어졌어요", "가죽이 벗겨졌어요", "손잡이가 부러졌어요", "찍혔어요", "스크래치가 났어요") 절대로 제품 목록을 나열하지 마세요.
    올바른 답변: 해당 손상 유형에 대한 AS 정보(수선 가능 여부, 소요 기간, 접수 준비물 등)를 먼저 안내하고, 수선 접수 방법을 덧붙이세요.
    예: "지퍼 손상은 수선으로 처리 가능합니다. 수선 소요 기간은 손상 정도에 따라 최소 2주 이상이며, 정확한 비용은 실물 진단 후 확정됩니다. 접수 시 손상 부위 사진을 준비하시면 AI 예상 견적도 미리 확인하실 수 있어요."
    접수를 강요하지 말고, 고객이 더 궁금한 점이 있으면 계속 대화를 이어가세요.
    절대 금지: 손상 키워드(지퍼, 가죽, 손잡이 등)로 제품 목록을 검색해 나열하는 것
31. 상품 정보를 나열할 때는 최대 3개까지만 보여주세요.
    3개를 초과하면 "해당하는 제품이 여러 가지입니다. 제품명이나 상품 코드를 더 구체적으로 알려주시면 정확히 안내해 드릴게요."라고 안내하세요. """
...
FILLER_PATTERNS = [re.compile(p) for p in [
    ...
    r"참고해\s*주시면\s*(됩니다|돼요)",      # "이 날짜를 참고해 주시면 됩니다" 등
    r"참고하시면\s*(좋겠습니다|좋을\s*것\s*같)",
    r"^기타\s*문의",
    r"^필요하시면\s*말씀",
...
REFER_EXCEPTIONS = ["보증서", "워런티", "영수증", "카드", "더스트백", "택", "tag",
                    "주문번호", "구성품", "박스", "케이스",
                    "파손", "운송", "보험"]   # 운송 중 파손 보상 → KB로 직접 답한다
...
def _retrieve(question, history=None, as_id=None):
    ...
    # 신규 상담 (as_id 없음) — 접수 건 없음을 명시적으로 자료에 넣는다.
    # 없으면 GPT 가 이전 대화나 STAGE_GUIDE 예시를 근거로 단계·날짜를 단정할 수 있다.
    if not as_id:
        pinned.insert(0, {
            "topic": "신규 상담 — 접수 건 없음",
            "keywords": [], "source": "시스템",
            "content": (
                "이 상담에는 지정된 접수 건이 없다. 반드시 지켜라:\n"
                "- 특정 접수 건의 현재 단계·전체 AS 완료 예정일·진행 이력을 말하지 마라. 알 수 없다.\n"
                "- 고객이 '제 수선 어디까지 됐어요?', '언제 끝나요?', '제 가방 어디 있어요?' 등 "
                "자신의 접수 건 현황을 물으면 이렇게 답해라:\n"
                "  '어느 접수 건인지 확인이 필요합니다. A/S 조회에서 해당 건을 선택해 "
                "상담을 시작하시면 현재 단계와 전체 AS 완료 예정일을 바로 안내드릴 수 있어요.'\n"
                "- 수선 절차 일반(단계 흐름, 소요 기간 등)은 설명해도 된다.\n"
                "- '고객님의 건이 지금 X 단계입니다'처럼 특정 단계를 절대 단정하지 마라."
            ),
        })
    ...
    if followup and history and not pinned and not any(h["topic"].startswith("상품") for h in hits):
...
TEST_CASES = [
    ...
    ("수선 끝나면 어떻게 받아요?", "접수 시 선택한 반환 방법 · A/S 조회 화면에서 운송장 확인"),
