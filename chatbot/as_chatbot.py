...
AS_KNOWLEDGE = [
    ...
    },
    {
        ...
        "content": (
            ...
            "예약한 날짜·시간에 문 앞이나 기사와 협의된 장소에 제품 본체만 두시면 됩니다.\n"
            "별도 포장이나 동봉물은 필요 없습니다.\n"
            "운송 구간 전체에 보험이 적용됩니다."
        ),
    },
    {
...
STAGE_GUIDE = {
    ...
    "접수완료": (
        ...
        "예약한 날짜·시간에 문 앞(또는 접수 시 지정한 수거 주소)에 제품 본체만 두면 된다.",
        "다음: 기사 방문 수거(픽업완료)",
    ),
    "픽업완료": (
...
23. 수선 취소·제품 반환·AS 거부 등 정책 관련 질문은 자료에 없으면 확정적으로 답하지 마세요.
    "수선 절차를 거쳐야 합니다", "불가능합니다" 같은 단정 표현 대신
    "상담원에게 문의하시면 정확히 안내받을 수 있습니다"라고 하세요.
